...
import Gallery from "../galleries/gallery.model.js";
...
const deleteUser = async (req, res, next) => {
  ...
  try {
    ...
    const result = await cloudinaryService.deleteImagesAndFolder({ folderPath: `users/${user._id.toString()}` });
    ...
    await Promise.all([
      ...
      Gallery.deleteOne({ userId: user._id }),
    ]);
